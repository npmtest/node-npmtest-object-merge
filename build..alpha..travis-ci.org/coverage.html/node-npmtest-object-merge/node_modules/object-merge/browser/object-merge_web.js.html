...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-object-merge/node_modules/object-merge/browser/object-merge_web.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-object-merge">npmtest-object-merge (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-object-merge/node_modules/object-merge/browser/object-merge_web.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-object-merge/node_modules/object-merge/browser/</a> &#187; object-merge_web.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function cloneFunction(func) {</span>
<span class="cstat-no" title="statement not covered" >    var out, str;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        str = func.toString();</span>
<span class="cstat-no" title="statement not covered" >        if (/\[native code\]/.test(str)) {</span>
<span class="cstat-no" title="statement not covered" >            out = func;</span>
        } else {
<span class="cstat-no" title="statement not covered" >            out = eval('(function(){return ' + str + '}());');</span>
        }
    } catch (e) {
<span class="cstat-no" title="statement not covered" >        throw new Error(e.message + '\r\n\r\n' + str);</span>
    }
<span class="cstat-no" title="statement not covered" >    return out;</span>
}
<span class="cstat-no" title="statement not covered" >module.exports = cloneFunction;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function objectForeach(obj, callback) {</span>
    "use strict";
<span class="cstat-no" title="statement not covered" >    Object.keys(obj).forEach(<span class="fstat-no" title="function not covered" >function (prop) {</span></span>
...
<span class="cstat-no" title="statement not covered" >module.exports = objectForeach;</span>
...
/*jslint
    ...
    node: true
*/
<span class="fstat-no" title="function not covered" >function ObjectMergeOptions(opts) {</span>
    'use strict';
<span class="cstat-no" title="statement not covered" >    opts = opts || {};</span>
<span class="cstat-no" title="statement not covered" >    this.depth = opts.depth || false;</span>
    // circular ref check is true unless explicitly set to false
    // ignore the jslint warning here, it's pointless.
<span class="cstat-no" title="statement not covered" >    this.throwOnCircularRef = 'throwOnCircularRef' in opts &amp;&amp; opts.throwOnCircularRef === false ? false : true;</span>
}
/*jslint unparam:true*/
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function createOptions(opts) {</span>
    'use strict';
<span class="cstat-no" title="statement not covered" >    var argz = Array.prototype.slice.call(arguments, 0);</span>
<span class="cstat-no" title="statement not covered" >    argz.unshift(null);</span>
<span class="cstat-no" title="statement not covered" >    var F = ObjectMergeOptions.bind.apply(ObjectMergeOptions, argz);</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function objectMerge(shadows) {</span>
    'use strict';
<span class="cstat-no" title="statement not covered" >    var objectForeach = require('object-foreach');</span>
<span class="cstat-no" title="statement not covered" >    var cloneFunction = require('clone-function');</span>
...
<span class="fstat-no" title="function not covered" >    function getShadowObjects(shadows) {</span>
<span class="cstat-no" title="statement not covered" >        var out = shadows.reduce(<span class="fstat-no" title="function not covered" >function (collector, shadow) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (shadow instanceof Object) {</span>
<span class="cstat-no" title="statement not covered" >                    collector.push(shadow);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    collector = [];</span>
                }
...
<span class="fstat-no" title="function not covered" >    function getOutputObject(shadows) {</span>
<span class="cstat-no" title="statement not covered" >        var out;</span>
<span class="cstat-no" title="statement not covered" >        var lastShadow = shadows[shadows.length - 1];</span>
<span class="cstat-no" title="statement not covered" >        if (lastShadow instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >            out = [];</span>
        } else <span class="cstat-no" title="statement not covered" >if (lastShadow instanceof Function) {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                out = cloneFunction(lastShadow);</span>
            } catch (e) {
<span class="cstat-no" title="statement not covered" >                throw new Error(e.message);</span>
            }
        } else <span class="cstat-no" title="statement not covered" >if (lastShadow instanceof Object) {</span>
<span class="cstat-no" title="statement not covered" >            out = {};</span>
        } else {
            // lastShadow is a primitive value;
<span class="cstat-no" title="statement not covered" >            out = lastShadow;</span>
        }
<span class="cstat-no" title="statement not covered" >        return out;</span>
    }
    // checks for circular references
<span class="fstat-no" title="function not covered" >    function circularReferenceCheck(shadows) {</span>
        // if any of the current objects to process exist in the queue
        // then throw an error.
<span class="cstat-no" title="statement not covered" >        shadows.forEach(<span class="fstat-no" title="function not covered" >function (item) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (item instanceof Object &amp;&amp; visited.indexOf(item) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error('Circular reference error');</span>
            }
        });
        // if none of the current objects were in the queue
        // then add references to the queue.
<span class="cstat-no" title="statement not covered" >        visited = visited.concat(shadows);</span>
    }
<span class="fstat-no" title="function not covered" >    function objectMergeRecursor(shadows, currentDepth) {</span>
<span class="cstat-no" title="statement not covered" >        if (options.depth !== false) {</span>
<span class="cstat-no" title="statement not covered" >            currentDepth = currentDepth ? currentDepth + 1 : 1;</span>
        } else {
<span class="cstat-no" title="statement not covered" >            currentDepth = 0;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (options.throwOnCircularRef === true) {</span>
<span class="cstat-no" title="statement not covered" >            circularReferenceCheck(shadows);</span>
        }
<span class="cstat-no" title="statement not covered" >        var out = getOutputObject(shadows);</span>
        /*jslint unparam: true */
<span class="fstat-no" title="function not covered" >        function shadowHandler(val, prop, shadow) {</span>
<span class="cstat-no" title="statement not covered" >            if (out[prop]) {</span>
<span class="cstat-no" title="statement not covered" >                out[prop] = objectMergeRecursor([</span>
                    out[prop],
                    shadow[prop]
                ], currentDepth);
            } else {
<span class="cstat-no" title="statement not covered" >                out[prop] = objectMergeRecursor([shadow[prop]], currentDepth);</span>
            }
        }
        /*jslint unparam:false */
<span class="fstat-no" title="function not covered" >        function shadowMerger(shadow) {</span>
<span class="cstat-no" title="statement not covered" >            objectForeach(shadow, shadowHandler);</span>
        }
        // short circuits case where output would be a primitive value
        // anyway.
<span class="cstat-no" title="statement not covered" >        if (out instanceof Object &amp;&amp; currentDepth &lt;= options.depth) {</span>
...
<span class="cstat-no" title="statement not covered" >            var relevantShadows = getShadowObjects(shadows);</span>
<span class="cstat-no" title="statement not covered" >            relevantShadows.forEach(shadowMerger);</span>
        }
<span class="cstat-no" title="statement not covered" >        return out;</span>
    }
...
<span class="cstat-no" title="statement not covered" >    if (arguments[0] instanceof ObjectMergeOptions) {</span>
<span class="cstat-no" title="statement not covered" >        options = arguments[0];</span>
<span class="cstat-no" title="statement not covered" >        shadows = Array.prototype.slice.call(arguments, 1);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        options = createOptions();</span>
<span class="cstat-no" title="statement not covered" >        shadows = Array.prototype.slice.call(arguments, 0);</span>
    }
<span class="cstat-no" title="statement not covered" >    return objectMergeRecursor(shadows);</span>
}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Wed Apr 19 2017 20:53:39 GMT+0000 (UTC)</div>
</div>
</body>
</html>
